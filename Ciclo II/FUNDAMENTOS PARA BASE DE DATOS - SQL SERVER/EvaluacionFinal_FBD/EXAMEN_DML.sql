Create Database DML
On (
    Name = DML_DATA, Filename ='c:\IDAT\DML_DATA.MDF',
	Size = 5MB, MaxSize = 10MB, Filegrowth = 10MB
	)
log ON
    (
    Name = SEMANA10_LOG, Filename ='c:\IDAT\DML_LOG.LDF',
	Size = 5MB, MaxSize = 10MB, Filegrowth = 5MB
	)
Go
Print 'Base de Datos DML creada Satisfactoriamente'
Go


Use DML
Go
Print 'Base de datos DML Esta Activa y Lista para usarce'
Go

Set Dateformat DMY
Print 'Cambio de Formato de Fecha a Dia/Mes/año Satisfactorio'
Go
...
Create Table Alumno(
 ...
 Print 'Tabla "Alumno" Creada Satisfactoriamente'
Go
...
Print 'Tabla "Cursos" Creada Satisfactoriamente'
Go
...
Print 'Tabla "Profesor" Creada Satisfactoriamente'
Go
...
Print 'Tabla "Notas" Creada Satisfactoriamente'
Go
...
-- Crear consultas del exámen desde aqui
