...
DROP ROLE ROL_12;
DROP USER USER12 CASCADE;
DROP TABLESPACE SEMANA_12 INCLUDING CONTENTS;

--1 Creando el TableSpace
Create TableSpace SEMANA_12 DataFile 'C:\IDAT\IDAT_12.DBF' Size 150M;

--2 Verificando la creación del TableSpace
Select * From v$tablespace;

--3 Ahora crearemos al usuario USER12, cuya contraseña será: 123456
Create User USER12 Identified by "123456"
Default TableSpace SEMANA_12
Temporary TableSpace TEMP
Quota unlimited on SEMANA_12;

--4 Creamos un Rol el cual contendrá los permisos, en este caso
-- el Role tendrá el nombre ROL_12
Create Role ROL_12;
...
Grant CONNECT, CREATE TABLE, RESOURCE, 
      ...
      UNLIMITED TABLESPACE To ROL_12;
      
--6 Asociamos (GRANT) el Rol: ROL_12 con el usuario USER12,
--  de esta manera el usuario USER12, podrá realizar las tareas
--  i/o permisos que el ROL_12 tiene.
Grant ROL_12 To USER12;
